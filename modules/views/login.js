        ...
        <nav class="relative z-20 w-full px-8 py-6 flex justify-between items-center animate-fade-in">
            ...
            <div class="flex items-center gap-6">
                <div class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/5">
                    ...
                    <span class="text-xs font-bold text-gray-300 uppercase tracking-wider">Système Opérationnel</span>
                </div>
            ...
            <div class="flex flex-col items-center pt-10 pb-20 px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full mb-32">
                    ...
                    <div class="glass-panel p-8 rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors text-left">
                        ...
                        <p class="text-sm text-gray-400 leading-relaxed">Un accès restreint garantissant une qualité de jeu supérieure et une communauté mature.</p>
                    </div>
                </div>
                ...
                <div class="mt-20 pt-10 border-t border-white/5 w-full max-w-4xl flex justify-between items-center text-xs text-gray-600">
                    <div>&copy; 2024 Team French RolePlay. Tous droits réservés.</div>
...
export const AccessDeniedView = () => `
    <div class="flex-1 flex flex-col items-center justify-center p-6 bg-[#050505] text-white animate-fade-in h-screen w-screen">
        <div class="glass-panel p-10 rounded-[40px] max-w-md w-full text-center border-red-500/30 shadow-[0_0_50px_rgba(239,68,68,0.1)]">
            <div class="w-24 h-24 bg-red-500/10 rounded-full flex items-center justify-center mx-auto mb-8 text-red-500 border border-red-500/20">
                <i data-lucide="shield-alert" class="w-12 h-12"></i>
            </div>
            
            <h2 class="text-3xl font-black tracking-tight mb-4 uppercase italic">Accès Interdit</h2>
            
            <p class="text-gray-400 mb-8 leading-relaxed">
                Vous ne faites pas partie du serveur Discord <span class="text-white font-bold italic">Team French RolePlay</span>. L'adhésion est obligatoire pour accéder au terminal citoyen.
            </p>
            
            <div class="space-y-4">
                <a href="${CONFIG.INVITE_URL}" target="_blank" class="glass-btn w-full py-4 rounded-2xl font-black text-sm flex items-center justify-center gap-3 bg-white text-black hover:scale-105 transition-all">
                    <i data-lucide="external-link" class="w-5 h-5"></i>
                    Rejoindre le Discord
                </a>
                
                <button onclick="actions.logout()" class="w-full py-4 rounded-2xl border border-white/10 text-gray-500 hover:text-white hover:bg-white/5 transition-all font-bold text-xs uppercase tracking-widest">
                    Changer de compte
                </button>
            </div>
        </div>

        ...
        <nav class="relative z-20 w-full px-8 py-6 flex justify-between items-center animate-fade-in">
            ...
            <div class="flex items-center gap-6">
                <div class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/5">
                    <div class="w-2 h-2 rounded-full ${isMaintenance ? 'bg-orange-500 animate-pulse' : 'bg-emerald-500'}"></div>
                    <span class="text-xs font-bold text-gray-300 uppercase tracking-wider">${isMaintenance ? 'Maintenance' : 'Système Opérationnel'}</span>
                </div>
...
export const AccessDeniedView = () => {
    ...
    <div class="flex items-center justify-center h-full w-full bg-[#050505] p-6 animate-fade-in">
        <div class="glass-panel max-w-md w-full p-8 rounded-2xl border-red-500/30 text-center shadow-[0_0_50px_rgba(220,38,38,0.1)]">
            ...
            <p class="text-gray-400 text-sm mb-8 leading-relaxed">
                Votre compte Discord ne possède pas les droits nécessaires ou n'est pas membre du serveur principal requis pour accéder au Terminal TFRP.
            </p>
            <div class="space-y-3">
                <a href="${CONFIG.INVITE_URL}" target="_blank" class="glass-btn w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500">
                    <i data-lucide="external-link" class="w-4 h-4"></i>
                    Rejoindre le Discord
                </a>
                <button onclick="actions.logout()" class="glass-btn-secondary w-full py-3 rounded-xl font-bold text-gray-400 hover:text-white flex items-center justify-center gap-2">

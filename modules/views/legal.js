...
export const TermsView = () => `
    <div class="flex flex-col h-full bg-[#050505] overflow-hidden animate-fade-in relative">
        <div class="absolute top-0 left-0 w-full h-[300px] bg-gradient-to-b from-blue-900/10 to-transparent pointer-events-none"></div>
        
        <!-- Header -->
        <div class="px-8 py-6 flex justify-between items-center border-b border-white/5 bg-[#050505]/80 backdrop-blur-md z-10 shrink-0">
            <div>
...
export const PrivacyView = () => `
    <div class="flex flex-col h-full bg-[#050505] overflow-hidden animate-fade-in relative">
        <div class="absolute top-0 left-0 w-full h-[300px] bg-gradient-to-b from-emerald-900/10 to-transparent pointer-events-none"></div>

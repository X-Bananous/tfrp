...
import { 
    ...
    fetchDailyEconomyStats, fetchPlayerInvoices, fetchTopSellers, fetchNotifications
} from '../services.js';
    ...
    try {
        ...
        if (panel === 'main') {
            ...
            if(state.activeEnterpriseTab === 'market') {
                ...
                promises.push(fetchTopSellers()); // CHARGEMENT IMMÉDIAT ICI
            }
            ...
            const promises = [fetchGlobalHeists(), fetchEmergencyCalls()];

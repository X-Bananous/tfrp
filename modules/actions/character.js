...
export const submitCharacter = async (e) => {
    ...
    const charData = {
        ...
        age: age,
        status: state.isAdminEditing ? 'accepted' : 'pending', // Admin creates instantly accepted
        user_id: targetUserId,
        alignment: data.alignment,
        job: 'unemployed',
        is_notified: false // Force false on create/edit
    };
...
export const setAlignment = async (alignment) => {
    ...
    const updates = { alignment: alignment, is_notified: false }; // Also reset on alignment change
